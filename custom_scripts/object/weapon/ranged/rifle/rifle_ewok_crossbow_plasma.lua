...
object_weapon_ranged_rifle_rifle_ewok_crossbow_plasma = object_weapon_ranged_rifle_shared_rifle_ewok_crossbow:new {
...
ObjectTemplates:addTemplate(object_weapon_ranged_rifle_rifle_ewok_crossbow_plasma, "object/weapon/ranged/rifle/rifle_ewok_crossbow_plasma.iff")
