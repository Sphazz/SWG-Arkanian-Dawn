...
object_weapon_ranged_rifle_rifle_flame_thrower_cold = object_weapon_ranged_rifle_shared_rifle_flame_thrower:new {
...
ObjectTemplates:addTemplate(object_weapon_ranged_rifle_rifle_flame_thrower_cold, "object/weapon/ranged/rifle/rifle_flame_thrower_cold.iff")
